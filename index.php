...
$lon = 13.2445;
$radius = 10;
$db = mysqli_connect("localhost", "d0181b74", "gnpGDs8tCHKHxTYa", "d0181b74");
/**
 * lat (breitengrad = nord -> sued): 50 ist noerdlicher als 49
 * lon (längengrad = west -> ost): 5 ist westlicher als 6  
 */
function getBoundingBox($lat, $lon, $radius, $db)
{

        // SQL-Befehl ausführen
    $befehl = mysqli_query($db, "SELECT * FROM geodata");
    return $befehl;
}

$coords = getBoundingBox($lat, $lon, $radius, $db);
?>
